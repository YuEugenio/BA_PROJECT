"""
Three-stream input mode: implant ROI + control ROI + global view.
Used by most legacy experiments.
"""
...
class TwoLocalOneGlobalDataset(Dataset):
    """Dataset returning (implant_tensor, control_tensor, global_tensor, labels_tensor)."""
    ...
    def __getitem__(self, idx) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        return tensors['implant'], tensors['control'], tensors['global'], labels
