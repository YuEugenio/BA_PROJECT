"""
train_global_lora_free.py - Two-stream training script with AUC analysis
"""
...
from model_global_lora_free import create_model, PES_TASK_NAMES


def compute_auc_metrics(labels: np.ndarray, probs: np.ndarray) -> dict:
    """
    Compute one-vs-rest multi-class AUC and ROC curves.
    """
...
def train_global_lora_free(
    ...
    try:
        from visualize import plot_training_curves, plot_confusion_matrices, plot_auc_curves
...
def main():
    parser = argparse.ArgumentParser(description='Train PES Two-Stream Model (Global_lora_free)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/data15/data15_5/yujun26/BA_PROJECT/Global_lora_free/outputs',
