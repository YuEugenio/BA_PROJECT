...
class PESMultiTaskModel(nn.Module):
    ...
    def _enable_qv_only_lora(self):
        """
        在qkv合并线性层上实现qv-only LoRA：屏蔽中间1/3（K）通道的LoRA更新
        Enable qv-only LoRA on fused qkv layers by masking K-channel updates.
        """
