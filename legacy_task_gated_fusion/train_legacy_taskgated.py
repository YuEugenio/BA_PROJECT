...
from model_legacy_taskgated import create_model, PES_TASK_NAMES
...
def train_legacy(
    ...
    run_metadata = {
        'model_name': 'model_legacy_taskgated',
        'timestamp': timestamp,
        'data_dir': data_dir,
        'label_file': label_file,
        'epochs': epochs,
    ...
    try:
        from visualize_legacy_taskgated import plot_training_curves, plot_confusion_matrices, plot_auc_curves
...
def main():
    parser = argparse.ArgumentParser(description='Train PES Multi-Task Classification Model (Legacy Task-Gated Fusion)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/data15/data15_5/yujun26/BA_PROJECT/legacy_task_gated_fusion/outputs',
