"""
Train baseline-style two-stream BioMedCLIP model.
"""
...
from model_baseline_biomedclip import PES_TASK_NAMES, create_model
...
def train_baseline_biomedclip(
    ...
    run_metadata = {
        'model_name': 'baseline_biomedclip_crossattn_linear',
        'timestamp': timestamp,
        'data_dir': data_dir,
        'label_file': label_file,
        'epochs': epochs,
...
def main():
    parser = argparse.ArgumentParser(description='Train baseline BioMedCLIP (cross-attn + linear)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/data15/data15_5/yujun26/BA_PROJECT/baseline_BioMedCLIP/outputs',
